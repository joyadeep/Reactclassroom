...
const Slider = () => {
  return (
    <div className='h-96 bg-pink-600/60 relative'>
        <div className='absolute top-0 w-full h-full bg-model bg-contain bg-no-repeat bg-bottom md:bg-right '/>
       
        <div className='absolute top-1/2 text-white px-5 md:px-20'>
